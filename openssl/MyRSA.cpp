...
int MyRSA::myEncrypt(const unsigned char *plain, int length, unsigned char **cipher, unsigned int &r_length) {
    key->reload();
...
int MyRSA::myDecrypt(const unsigned char *cipher, int length, unsigned char **plain, unsigned int &r_length) {
    key->reload();
...
int MyRSA::mySign(const unsigned char *plain, int length, unsigned char **cipher, unsigned int &r_length) {
    key->reload();
...
int MyRSA::myVerify(const unsigned char *cipher, int length, unsigned char *plain, int plainLength) {
    key->reload();
    EVP_PKEY *pkey = EVP_PKEY_new();
